...
After this, they will see 100 trials in a randomised order. Each trial has the questions, "Please indicate if this pair of faces shows siblings or an unrelated pair", two response buttons ("unrelated", "related") and the faces of the stimulus pair shown side-by-side below at a maximum of 600x800 pixels (or sized to fit screen width if the device screen is smaller than 1200px). Face images have hair and clothing masked in black.
