...
slug: simdf
categories: ["rstats"]
tags: ["r", "simulation", "ersatz"]
---

```{r load-libraries, message=FALSE}
# devtools::install_github("debruine/ersatz")
library(ersatz)
library(tidyverse)
```

I added a new function to the package [`ersatz`](https://github.com/debruine/ersatz) to generate a new dataframe from an existing dataframe, simulating all numeric columns from normal distributions with the same mean and SD as the existing data and the same correlation structure as the existing data.
