---
title: multisim::multirnorm
author: ~
date: '2018-12-22'
slug: multisim-multirnorm
categories: ["rstats"]
tags: ["R", "correlated data", "simulation"]
---
...
I'm working on a package for simulations called [multisim](https://github.com/debruine/multisim) (because I am bad at titling things).

The first function, `multirnorm`, makes multiple normally distributed vectors with specified relationships and takes the following arguments:
...
```{r}
ex1 <- multirnorm(100, 3, c(0.2, -0.5, 0.5), varnames=c("A", "B", "C"))
```
