...
The boxplot above showss the median and quartiles, which sometimes isn't the summary statistic you want to emphasise (HT [@PaulMinda1](https://twitter.com/PaulMinda1)). You can alternatively plot the mean and 95% CI using `geom_pointrange`. This requires a bit of data wrangling first.
